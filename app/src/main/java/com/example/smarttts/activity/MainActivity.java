...
import com.example.smarttts.binderlink.AppBinderHelper;
...
//		requestPermissions();
		...
		AppBinderHelper.getHelper().sendCRunBrodCast(this);
		AppBinderHelper.getHelper().bindService(this,"com.enjoy.memory","com.xier.keep.link.RemoteService");
	}
	@Override
